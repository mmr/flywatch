...
$search_config = 
    array('possible_fields'     => array('Name' => 'lnk_name',
                                         'URL'  => 'lnk_url',
                                         'Desc' => 'lnk_desc'),
          'select_fields'       => array('Name' => 'lnk_name',
                                         'URL'  => 'lnk_url',
                                         'Desc' => 'lnk_desc'),
...
?>
                    ...
                    <tr>
                        ...
                        <td class="searchtitle"><a href='#' onClick="b1n_orderBy('lnk_name');">Name</a></td>
                        <td class="searchtitle"><a href='#' onClick="b1n_orderBy('lnk_url');">Url</a></td>
                        <td class="searchtitle"><a href='#' onClick="b1n_orderBy('lnk_desc');">Desc</a></td>
...
?>
                    <tr>
                        ...
                        <td class="searchitem">&nbsp;<a href='<?= $item['lnk_url'] ?>' target='_blank'><?= b1n_inHtmlLimit($item['lnk_name']) ?></a></td>
                        <td class="searchitem">&nbsp;<?= b1n_inHtmlLimit($item['lnk_url']) ?></td>
                        <td class="searchitem">&nbsp;<?= b1n_inHtmlLimit($item['lnk_desc']) ?></td>
