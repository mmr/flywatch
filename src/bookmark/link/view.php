<?
/* $Id: view.php,v 1.1 2002/12/18 21:36:11 binary Exp $ */
$colspan = 2;
?>
<center>
    <br />
            ...
            <td>
                <table cellspacing="1" cellpadding="5" class="inttable">
                    ...
                    <tr>
                        ...
                        <td class='forminput'>&nbsp;<?= "<a href='" . $reg_data['lnk_url'] . "' target='_blank'>" . $reg_data['lnk_name'] . "</a>" ?></td>
                    </tr>
                    <tr>
                        <td class='formitem'>Desc</td>
                        <td class='forminput'><?= b1n_inHtmlLimit($reg_data['lnk_desc']) ?></td>
                    </tr>
                    <tr>
