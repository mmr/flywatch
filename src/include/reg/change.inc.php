<?
/* $Id: change.inc.php,v 1.18 2002/12/25 22:55:29 binary Exp $ */ 
?>
<center>
    <br />
    <br />
...
?>
                    <tr>
                        <td class='formitem' width='1'><?= $reg['mand'] && $reg['type'] != 'password' ? "*" : "&nbsp;" ?></td>
...
<?
    ...
    case "select":
        ...
        case "date_check_exp":
        case "date_check_dob":
            echo b1n_buildSelectFromDate($reg['reg_data'], $reg_data[$reg['reg_data']], $reg['extra']['year_start'], $reg['extra']['year_end']);
            break;
        case "date_hour":
            echo b1n_buildSelectFromDateHour($reg['reg_data'], $reg_data[$reg['reg_data']], $reg['extra']['year_start'], $reg['extra']['year_end']);
            break;
        case "fk":
